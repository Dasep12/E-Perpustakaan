             ...
             <form method="post" id="inputBuku" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="kd_buku" id="kdbuku" placeholder="Input Kode Buku">
                  </div>
                </div>
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Judul Buku</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="judul_buku" id="judul_buku" placeholder="Input  Judul Buku">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tahun Terbit</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="thn_terbit" id="thn_terbit" placeholder="Input  Tahun Terbit Buku">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pengarang" id="pengarang" placeholder="Input  Pengarang Buku">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="genre" id="genre" placeholder="Input  Genre / Kategori Buku">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Input  Lokasi Storage Buku">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="QTY Jumlah Buku">
                  </div>
                </div>
      ...
      $("#inputBuku").on('submit',function(e){
        e.preventDefault();
          if(document.getElementById('kdbuku').value == ""){
              ...
              $.ajax({
                  url : "<?php echo base_url('admin/Master_buku/input') ?>" ,
                  method : "POST" ,
                  ...
                  success : function(e){
                      if(e == "Sukses Input Buku"){
                        swal({
                          ...
                          window.location.href="<?php echo base_url('admin/Master_buku/Tambah_buku') ?>"
                        })
                      }else {
                        swal({
                          icon : "error" ,
